            ...
            <div class="om_create_order_box">
                ...
                <div class="om_create__product_details">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="firstName" name="first_name" value="<?php echo esc_attr($fields['first_name']); ?>" required>
                    </div>
                    <br>

                    <div class="form-group">
                        <label for="lastName">Last Name:</label>
                        <input type="text" id="lastName" name="last_name" value="<?php echo esc_attr($fields['last_name']); ?>" required>
                    </div>
                    <br>

                    <div class="form-group">
                        <label for="address">Address:</label>
                        <input type="text" id="address" name="address_1" value="<?php echo esc_attr($fields['address_1']); ?>">
                    </div>
                    <br>
                    
                    <div class="form-group">
                        <label for="address_number">Street Number:</label>
                        <input type="text" id="address_number" name="address_number" value="<?php echo esc_attr($fields['street_number']); ?>">
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo esc_attr($fields['email']); ?>" required>
                    </div>
                    <br>

                    <div class="form-group">
                        <label for="phone">Phone:</label>
                        <input type="tel" id="phone" name="phone" value="<?php echo esc_attr($fields['phone']); ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="form-group form-group-row">
                        ...
                        <div class="form-group-flex">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="subscribed" id="yes" value="yes" <?php checked($fields['subscribed'], 'yes', true); ?>>
                ...
                <div class="om_create__customer_details">
                    <div class="om_hidden_details" style="display: <?php echo $fields['client_type'] ? 'block' : 'none'; ?>;">
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?php echo esc_attr($fields['dark_logo']); ?>" style="max-width: 300px; display: <?php echo $fields['dark_logo'] ? 'block' : 'none'; ?>;;" />
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <img src="<?php echo esc_attr($fields['lighter_logo']); ?>" style="max-width: 300px; display: <?php echo $fields['lighter_logo'] ? 'block' : 'none'; ?>;;" />
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <img src="<?php echo esc_attr($fields['back_light']); ?>" style="max-width: 300px; display: <?php echo $fields['back_light'] ? 'block' : 'none'; ?>;;" />
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <img src="<?php echo esc_attr($fields['back_dark']); ?>" style="max-width: 300px; display: <?php echo $fields['back_dark'] ? 'block' : 'none'; ?>;;" />
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?php echo esc_attr($fields['logo']); ?>" style="max-width: 300px; display: <?php echo $fields['logo'] ? 'block' : 'none'; ?>;" />
                        </div>
                        <br>
                    </div>
                </div>
